    ...
    <footer className="bg-[#1E293B] py-12 text-white">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/report" className="text-white/70 hover:text-white">
                  Report a Site
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/ngo-dashboard" className="text-white/70 hover:text-white">
                  NGO Dashboard
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h3 className="font-poppins mb-4 text-lg font-bold">Connect</h3>
        ...
        <div className="mt-12 border-t border-white/10 pt-8 text-center text-sm text-white/60">
          <p>© {new Date().getFullYear()} CleanQuest. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
